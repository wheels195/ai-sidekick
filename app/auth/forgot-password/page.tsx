...
import { Sparkles, ArrowLeft, Mail, Shield, RotateCcw } from "lucide-react"
              ...
              <CardContent className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-xl font-semibold text-white">Reset Email Sent</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-black relative">
      ...
      <main className="relative z-10 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500/10 to-red-500/10 backdrop-blur-xl border border-orange-500/20 rounded-full px-6 py-3 mb-6 hover:scale-105 transition-all duration-300">
              <RotateCcw className="w-5 h-5 text-orange-400" />
              <span className="text-orange-300 font-medium">Reset Password</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent">
                Reset Your Password
          ...
          <Card className="backdrop-blur-2xl bg-gray-800/40 border-gray-600/30 shadow-2xl">
            <CardHeader>
              <CardTitle className="text-xl text-white text-center">Password Reset</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="mb-6 p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-orange-300 text-sm">
                    <p className="font-medium mb-1">For existing password accounts</p>
                    <p>This will reset the password for accounts that already have email/password authentication set up.</p>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-white/5 border-white/20 text-white placeholder-gray-400 focus:border-orange-500/50 focus:ring-orange-500/25"
                    disabled={isLoading}
                  />
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                  <h3 className="text-blue-300 font-medium mb-2">Don't have a password yet?</h3>
                  <p className="text-sm text-gray-300 mb-3">
                    If you signed up with Google and want to add password authentication, use the "Create Password" option instead.
                  </p>
                  <Button
                    type="button"
                ...
                <div className="text-center">
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-400 hover:to-red-400 text-white shadow-xl hover:shadow-orange-500/25 transition-all duration-300 hover:scale-105 py-3"
                  >
                    {isLoading ? (
