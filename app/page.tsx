        ...
        <div className="max-w-7xl xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-20">
          <div className="text-center mb-20">
            ...
            <div className="text-center mt-8">
              <a 
                href="/learn" 
                className="inline-flex items-center text-emerald-400 hover:text-emerald-300 transition-all duration-300 hover:scale-105 text-lg lg:text-xl underline underline-offset-4 decoration-emerald-400/50 hover:decoration-emerald-300"
              >
