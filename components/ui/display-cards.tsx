  ...
  return (
    <div className="grid grid-cols-1 2xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-none w-full auto-rows-fr">
      {cards.map((card, index) => (
        <Card 
          key={index}
          className="group w-full h-full min-h-[160px] bg-white/5 backdrop-blur-md ring-1 ring-white/10 rounded-xl shadow-2xl hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/20 hover:ring-white/30 hover:bg-white/10 transition-all duration-500 ease-out cursor-pointer relative overflow-hidden"
            ...
            <div className="flex items-start gap-4 flex-1">
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-white/80 mb-3 sm:mb-4 leading-relaxed tracking-wide transition-colors duration-300 group-hover:text-white/90">
                    {card.description}
                  </p>
                </div>
                <div>
